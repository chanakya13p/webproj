<?php
	...
	if ($_SESSION['signuser'] == 0 ){
		...
		if ($from == 1){
			...
			header('Location:http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewTeam.php?team_id='.$team_id.'&page=1');
		}
			...
			header('Location:http://www.cs.odu.edu/~cpallapo/CS518/proj4/posts.php?page=1');
		}
			...
			header('Location:http://www.cs.odu.edu/~cpallapo/CS518/proj4/posts.php?page='.$page);
		}
			...
			header('Location:http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewThread.php?post_id='.$post_id.'&team_id='.$team_id.'&page=1');
		}
		else if ($from == 7){
			...
			header('Location:http://www.cs.odu.edu/~cpallapo/CS518/proj4/memstats.php?name='.$name);
		}
