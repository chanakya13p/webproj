						...
						if($password != $confirmpassword){
							...
							if($image){
								...
								if($emailoption == "html"){
									...
									$message .= "<html><a href=\"http://www.cs.odu.edu/~cpallapo/CS518/proj4/confirm.php"."?id=$activation_code\">Click here to confirm</a></html>";
									...
									if($mailsent){
										...
										$profile_page_display = "insert into proj4_profile_page_display(username) values ('$username') ";
										$profile_page_display_res = $con->query($profile_page_display);
								...
								if($emailoption == "plain"){
									...
									$message .= "http://www.cs.odu.edu/~cpallapo/CS518/proj4/confirm.php"."?id=$activation_code\n";
									$message .= "\r\n\nThanks \n HallaBol";
									$headers = "MIME-Version: 1.0\r\n";
									$headers .= "Content-type: text/html; charset=iso-8859-1\r\n";
									$headers .= "Content-Transfer-Encoding: 7bit\r\n";
