					...
					alert(post);*/
		 			$.ajax({								
						...
						success:function(data){
							if(data==2){									
								window.location.href='http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewTeam.php?team_id=<?php echo $team_id;?>' ;
							}
							else if(data==0){
								...
								//window.location.href='http://www.cs.odu.edu/~cpallapo/CS518/proj4/index.php';
								//document.getElementById("modal-container-new").show();
							}
							else if(data==3){
								alert('Too Many Images!!');
								window.location.href='http://www.cs.odu.edu/~cpallapo/CS518/proj4/newDiscussion.php?team_id=<?php echo $team_id; ?>';
								//window.reload();
							}
							else if(data==6){
