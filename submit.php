<?php
	...
	if ($newdisc == 1){
		...
		$title = mysqli_real_escape_string($con,$title);
			...
			header( 'Location: http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewTeam?team_id='.$team_id );	
	}
		...
		if (strlen($comment1)==0){
			...
			header( 'refresh:0,http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewThread.php?post_id='.$post_id.'&team_id='.$team_id.'&page=1' ) ;
		}
