<?php	
	...
	if ($_SESSION['signuser'] == 0 ){
		...
		if($delete_check_val['username'] != $pres_user){
			header('Location:http://www.cs.odu.edu/~cpallapo/CS518/proj4/session.php');
		}
									...
									alert(post);*
						 			$.ajax({								
										...
										success:function(data){
											if(data==2){
												window.location.href='http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewThread.php?post_id=<?php echo $post_id;?>&team_id=<?php echo $team_id;?>&page=1';
											}
											else if(data==0){
												//$("#modal-container-deleted").show();
												alert('You have been deleted from the Forum. You cannot Post anymore!!');
												window.location.href='http://www.cs.odu.edu/~cpallapo/CS518/proj4/session.php';
	...
	*/
								...
								$("#submissionfull").submit(function(){
									...
									$.ajax({								
										...
										success:function(data){
											if(data == 5)
											{
												window.location.href='http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewThread.php?post_id=<?php echo $post_id;?>&team_id=<?php echo $team_id;?>';
											}	
											else if(data == 1){
						...
						<?php
							...
							<?php 	
								$update = "update proj4_profile_page_display set entered ='0' where username = '$username'";
													...
													<div class="heroContent">
														...
														<?php }else if($freeze_value['freeze'] == 0){ ?>
															...
															<?php }else if($suspend_value['suspension'] == 0){ ?>
																<form id ="submissionfull" role="form" method="POST" action="submit.php?viewthread=2">								
																	<label for="textArea" class="col-lg-2 control-label">Comment Area</label>
																	<textarea  class = "form-control" rows="5" name="comment1" id="comment1" placeholder="Comment...." style=" resize:none;"></textarea><br>					
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div id="modal-30"class="modal-body">
														...
														<a id="modal-309293" href="http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewThread.php?post_id=<?php echo $post_id;?>&team_id=<?php echo $team_id;?>&page=<?php echo $page; ?>" data-toggle="modal" >
										            ...
										            var options = {
										                ...
										                totalPages:<?php echo $totalpages;?>,
														 ...
														 onPageClicked: function(e,originalEvent,type,page){
										               		 window.location.href = 'http://www.cs.odu.edu/~cpallapo/CS518/proj4/viewThread.php?post_id=<?php echo $post_id;?>&team_id=<?php echo $team_id;?>&page='+page;
										            	}
													}
